...
// Retrieve product information from the previous page (Productos.html) and generate table row
var producto = "Producto"; // Replace with the actual product name from Productos.html
var cantidad = 1; // Replace with the actual quantity from Productos.html
